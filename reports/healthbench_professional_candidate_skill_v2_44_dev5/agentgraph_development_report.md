...
- completed-only native mean raw：0.48333333 (2/5)；length-adjusted：0.47909973 (2/5)
- completed-only 是实际已观测子集的描述性均分，不能与旧版本完整五题均分直接当作提升或下降比较。
- 已落盘 trajectory 内 Agent recorded model calls：30；Director recorded phase calls：18；observed Tool calls（题内去重后求和）：12；全五题 actual Tool calls：N/A
...
|---|---:|---:|---|---|---|---:|---|---:|---:|---:|
| healthbench-professional:f056cdb489e3636b0b51afb8fd6b3a8a | 0.5 | 0.4560764 | true | true | false | 2 / 2 | node_2 → node_1 | 20 | 7 | 0 |
...
| healthbench-professional:dadbebd3dce1b5928cac5a44dde095d3 | 0.46666667 | 0.50212307 | true | true | false | 3 / 3 | node_1 → node_2; node_2 → node_3 | 10 | 5 | 0 |
...
- Agent model calls：`{"MiniMax-M3": 12, "qwen3.5-9b-local": 8}`；missing-source receipts=0
- Director turns=5；recorded phase calls=10；turn attempts=20 (5/5)；turn latency_ms=76483.098 (5/5)
- Tool calls：`{"healthbench-knowledge.search": 3, "healthbench-literature.search": 2, "healthbench-source.read": 1, "healthbench-trials.search": 1}`；raw receipts=10；duplicates=3；latency_ms=8935.0433 (7/7)
- Terminal reason：finish；errors=`{"execution_error_types": {}, "grader_error_present": false, "grader_provider_errors": 0, "provider_identified_runtime_failure_receipts": 0, "runtime_failure_receipts": 2, "runtime_failure_types": {"ReactExecutionError": 2}}`；tool errors=`{}`

| Receipt scope | Prompt tokens | Completion tokens | Provider total tokens | Latency ms |
|---|---:|---:|---:|---:|
| Agent recorded calls | 169736 (20/20) | 17388 (20/20) | 187832 (20/20) | 256421.01 (20/20) |
| Director recorded phases | 131071 (10/10) | 4976 (10/10) | N/A (0/10) | 37352.686 (10/10) |

- Grader model=gpt-5.4-2026-03-05；saved telemetry=`{"api_call_receipts": 2, "api_calls": 2, "latency_ms": 5783.519842661917, "model_id": "gpt-5.4-2026-03-05", "token_usage": {"input_cached_tokens": 0, "input_tokens": 2986, "output_reasoning_tokens": 155, "output_tokens": 334, "total_tokens": 3320}, "usage_scope": "saved grader_telemetry for this terminal evaluator receipt; no unrecorded retries"}`
...
- Director turns=4；recorded phase calls=8；turn attempts=20 (4/4)；turn latency_ms=60017.981 (4/4)
- Tool calls：`{"healthbench-authoritative.search": 3, "healthbench-literature.search": 1, "healthbench-medrag.search": 1}`；raw receipts=5；duplicates=0；latency_ms=12174.345 (5/5)
...
| Receipt scope | Prompt tokens | Completion tokens | Provider total tokens | Latency ms |
|---|---:|---:|---:|---:|
| Agent recorded calls | 59170 (10/10) | 6916 (10/10) | 66086 (10/10) | 51246.728 (10/10) |
| Director recorded phases | 84928 (8/8) | 3362 (8/8) | N/A (0/8) | 25319.182 (8/8) |

- Grader model=gpt-5.4-2026-03-05；saved telemetry=`{"api_call_receipts": 2, "api_calls": 2, "latency_ms": 4714.1537014395, "model_id": "gpt-5.4-2026-03-05", "token_usage": {"input_cached_tokens": 0, "input_tokens": 1715, "output_reasoning_tokens": 123, "output_tokens": 262, "total_tokens": 1977}, "usage_scope": "saved grader_telemetry for this terminal evaluator receipt; no unrecorded retries"}`
