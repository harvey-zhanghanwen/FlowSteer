# HotpotQA Architecture Validation — hotpotqa_director_observation_v7_dev128
...
| AgentGraph | 128 | 128 | 72.66 | 80.92 |

AgentGraph − Direct: **+0.00 EM**, **-1.16 F1**.

## Failure types

- `architecture_gain`: 11
- `architecture_regression_candidate`: 11
- `correct`: 82
- `partial_or_overlong_answer`: 13
