# HotpotQA Architecture Validation — hotpotqa_deep_v6_formal_step2_dev128
...
| AgentGraph | 128 | 128 | 69.53 | 80.18 |

AgentGraph − Direct: **-3.12 EM**, **-1.89 F1**.

## Failure types

- `architecture_gain`: 11
- `architecture_regression_candidate`: 15
- `correct`: 78
