# HotpotQA Architecture Validation — hotpotqa_deep_v6_formal_step0_dev128
...
| AgentGraph | 128 | 128 | 67.19 | 78.84 |

AgentGraph − Direct: **-5.47 EM**, **-3.24 F1**.

## Failure types

- `architecture_gain`: 10
- `architecture_regression_candidate`: 17
- `correct`: 75
