# HotpotQA Architecture Validation — hotpotqa_deep_v6_formal_step1_dev128
...
| AgentGraph | 128 | 128 | 64.84 | 76.93 |

AgentGraph − Direct: **-7.81 EM**, **-5.14 F1**.
...
- `shared_reasoning_or_model_failure_candidate`: 12
