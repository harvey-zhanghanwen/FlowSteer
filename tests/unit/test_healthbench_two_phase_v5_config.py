...
CONFIG = ROOT / "config" / (
    "evaluation_healthbench_professional_two_phase_artifact_v5_gpt54_rubric.yaml"
)


class HealthBenchTwoPhaseV5ConfigTest(unittest.TestCase):
    def test_v5_is_evaluation_only_two_phase_and_topology_neutral(self) -> None:
    ...
    def test_v5_prompt_adds_no_fixed_medical_role_or_topology(self) -> None:
    ...
    def test_v5_model_visible_config_contains_no_evaluator_truth(self) -> None:
