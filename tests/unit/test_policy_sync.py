...
class PolicySyncTests(unittest.TestCase):
    ...
    def test_server_runtime_receipt_records_batch_invariant_boundary(self) -> None:
        ...
        self.assertEqual(
            receipt["max_running_requests_source"], "max_running_requests"
        )
        self.assertEqual(receipt["configured_max_running_requests"], 4)
    ...
    def test_server_runtime_receipt_uses_sglang_effective_auto_limit(self) -> None:
        control = _SGLangControl(set())
        control.server_info_payload["max_running_requests"] = None
        control.server_info_payload["internal_states"] = [
            {"effective_max_running_requests_per_dp": 82}
        ]
        ...
        self.assertIsNone(receipt["configured_max_running_requests"])
