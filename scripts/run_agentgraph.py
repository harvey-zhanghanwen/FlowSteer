...
def main() -> int:
    ...
    parser.add_argument("--director-url", default="http://127.0.0.1:8003/v1")
    parser.add_argument("--director-model", default="qwen3.5-9b-director")
    parser.add_argument("--policy-version", default="qwen3.5-9b-local-v1")
