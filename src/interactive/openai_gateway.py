...
_HOTPOTQA_REASONER_PROTOCOL = (
    ...
    "then align that proposition to the answer slot actually requested. Apply the "
    ...
    "the person/possessor entity rather than a possessive attribute phrase. You alone "
...
_HOTPOTQA_VERIFIER_PROTOCOL = (
    ...
    "and the original question scope was not narrowed or changed and its wh-word "
    "answer type was preserved. In a Which-comparison, reject a numeric/date comparison value as the "
    "candidate; in a who-question, reject a possessive attribute phrase instead of "
    "the person entity. You must not "
