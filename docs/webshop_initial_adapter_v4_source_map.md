# WebShop initial adapter v4 source map
...
- v4 adds only the missing receipt persistence and exact bounded-rollout check.
  v1/v2/v3 artifacts are retained under their original condition directories
  and are never mixed into v4.
