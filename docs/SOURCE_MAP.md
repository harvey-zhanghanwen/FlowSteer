...
`agentgraph.director.hotpotqa-semantic-recovery.v21` and
`hotpotqa_verified_answer_slot_v1`.  Prompts v20 and earlier remain legacy,
...
Prompt v21 is the current policy delta over the versioned v20 policy. It keeps
...
candidate/value/evidence content. Prompt v20 and older receipts retain their
