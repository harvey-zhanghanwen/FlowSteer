# HotpotQA Round-01 + transductive QA-memory v18 source map

v18 starts from the verified highest `hotpotqa_round_01_stable_zero` profile
...
Any v18 EM/F1 must remain separate from the held-out Round-01 best profile and
